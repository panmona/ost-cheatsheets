...
% TODO für den Moment mal heraus gekürzt, da es nicht so nötig scheint wie andere Dinge
...
\begin{description}
    \item[One-way in] Model to view \mintinline{html+ng2}|<p>{{counter.team}}</p>|, \mintinline{html+ng2}|<img [attr.alt]="counter.team" src="...">|
...
% TODO option two: declare as part of ngModule, place into forRoot (explained in more detail later in the module)
...
% TODO Was macht @Injectable
% TODO Was macht providedIn: root? Wie gleiche Semantik erreichen wenn weggelassen?
% TODO property werte mit moustache syntax in template rendern: wie?
